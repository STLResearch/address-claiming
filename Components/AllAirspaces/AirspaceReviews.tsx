...
const AirspaceReviews = (props) => {
  return (
    ...
    >
      ...
      <div style={{ width: "100%", height: "40%" }} className="overflow-y-auto bg-white pt-6">
        <div style={{ width: "299px" }} className="mx-auto rounded bg-light-blue p-2.5">
          <p>
            “Lorem ipsum dolor sit amet, consectetur adipiscing et, sed do eiusmod tempor incididunt ut Duis aute irure
            dolor in reprehe nderit in voluptate velit esse cillum do lore eu fugiat nulla pariatu labore t enim ad
            minima ve niam, quis nostrum exercitationem”
          </p>
        ...
        <div className="me-5 mt-2.5 flex flex-row items-center justify-start">
          ...
          <div className="me-5 ms-2">
            <p className="font-base text-sm font-bold text-light-brown">John Doe</p>
