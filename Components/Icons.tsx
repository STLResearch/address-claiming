...
export const GiftIcon = ({ isActive }) => {
  return (
    <svg width="47" height="45" viewBox="0 0 47 45" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M14.3334 22.5H31.6667V29.875C31.6667 30.9796 30.7713 31.875 29.6667 31.875H16.3334C15.2288 31.875 14.3334 30.9796 14.3334 29.875V22.5Z"
        stroke="#4285F4"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
      ...
      />
      <path
        d="M30.5834 15.4583C30.5834 14.1697 29.5387 13.125 28.25 13.125H27.0323C24.8053 13.125 23 14.9303 23 17.1573V17.1573C23 17.2315 23.0602 17.2917 23.1344 17.2917H28.75C29.7626 17.2917 30.5834 16.4709 30.5834 15.4583V15.4583Z"
        stroke="#4285F4"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
...
export const Tooltip = ({ isCopied }) => (
  <div className="absolute -left-6 -top-14 z-[1000] rounded-md bg-gray-900 px-4 py-2 text-white opacity-100 transition duration-300">
...
export const ZoomInIcon = () => {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="12" cy="12" r="5" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10 12H12M14 12H12M12 12V10M12 12V14" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const ZoomOutIcon = () => {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="24" height="24" rx="8" fill="white" />
      <circle cx="12" cy="12" r="5" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10 12H12H14" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
export const LoadingSpinner = ({ color }) => {
  return (
    <svg
      className={`-ml-1 h-5 w-5 animate-spin text-${color}`}
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
    >
...
export const FailedVerificationIcon = () => {
  return (
    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M21 16V22M30 21C30 25.9706 25.9706 30 21 30C16.0294 30 12 25.9706 12 21C12 16.0294 16.0294 12 21 12C25.9706 12 30 16.0294 30 21Z"
        stroke="white"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
...
export const ReviewVerificationIcon = () => {
  return (
    <svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M25.5 21H21.25C21.1119 21 21 20.8881 21 20.75V17.5"
        stroke="white"
        stroke-width="2"
        stroke-linecap="round"
      />
...
export const DocumentApprovedIcon = () => {
  return (
    <svg width="100%" height="100%" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M8.5 4.25C6.016 4.25 4 6.266 4 8.75C4 11.234 6.016 13.25 8.5 13.25C10.984 13.25 13 11.234 13 8.75C13 6.266 10.984 4.25 8.5 4.25ZM8.5 12.35C6.5155 12.35 4.9 10.7345 4.9 8.75C4.9 6.7655 6.5155 5.15 8.5 5.15C10.4845 5.15 12.1 6.7655 12.1 8.75C12.1 10.7345 10.4845 12.35 8.5 12.35ZM10.246 7.0805L7.6 9.7265L6.754 8.8805C6.5785 8.705 6.295 8.705 6.1195 8.8805C5.944 9.056 5.944 9.3395 6.1195 9.515L7.285 10.6805C7.4605 10.856 7.744 10.856 7.9195 10.6805L10.885 7.715C11.0605 7.5395 11.0605 7.256 10.885 7.0805C10.7095 6.905 10.4215 6.905 10.246 7.0805Z"
        fill="white"
      />
    </svg>
  );
  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g clip-path="url(#clip0_2140_17567)">
        <path
          d="M11.1761 5.55117C11.0018 5.37692 10.7204 5.37692 10.5461 5.55117L8.3614 7.73144L6.17665 5.5467C6.00241 5.37245 5.72094 5.37245 5.5467 5.5467C5.37245 5.72094 5.37245 6.00241 5.5467 6.17665L7.73144 8.3614L5.5467 10.5461C5.37245 10.7204 5.37245 11.0018 5.5467 11.1761C5.72094 11.3503 6.00241 11.3503 6.17665 11.1761L8.3614 8.99135L10.5461 11.1761C10.7204 11.3503 11.0018 11.3503 11.1761 11.1761C11.3503 11.0018 11.3503 10.7204 11.1761 10.5461L8.99135 8.3614L11.1761 6.17665C11.3459 6.00688 11.3459 5.72094 11.1761 5.55117Z"
          fill="white"
        />
      </g>
      <defs>
  ...
  return (
    <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_112_9711)">
        <path
          d="M20.3767 6.35831C19.9425 5.92406 19.241 5.92406 18.8067 6.35831L13.3619 11.792L7.91714 6.34717C7.4829 5.91292 6.78142 5.91292 6.34717 6.34717C5.91292 6.78142 5.91292 7.4829 6.34717 7.91714L11.792 13.3619L6.34717 18.8067C5.91292 19.241 5.91292 19.9425 6.34717 20.3767C6.78142 20.811 7.4829 20.811 7.91714 20.3767L13.3619 14.9319L18.8067 20.3767C19.241 20.811 19.9425 20.811 20.3767 20.3767C20.811 19.9425 20.811 19.241 20.3767 18.8067L14.9319 13.3619L20.3767 7.91714C20.7998 7.49403 20.7998 6.78142 20.3767 6.35831Z"
          fill="white"
        />
      </g>
      <defs>
...
export const AccountNotificationIcon = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M6.44784 8.96942C6.76219 6.14032 9.15349 4 12 4C14.8465 4 17.2378 6.14032 17.5522 8.96942L17.804 11.2356C17.8072 11.2645 17.8088 11.279 17.8104 11.2933C17.9394 12.417 18.3051 13.5005 18.8836 14.4725C18.8909 14.4849 18.8984 14.4973 18.9133 14.5222L19.4914 15.4856C20.0159 16.3599 20.2782 16.797 20.2216 17.1559C20.1839 17.3946 20.061 17.6117 19.8757 17.7668C19.5971 18 19.0873 18 18.0678 18H5.93223C4.91268 18 4.40291 18 4.12434 17.7668C3.93897 17.6117 3.81609 17.3946 3.77841 17.1559C3.72179 16.797 3.98407 16.3599 4.50862 15.4856L5.08665 14.5222C5.10161 14.4973 5.10909 14.4849 5.11644 14.4725C5.69488 13.5005 6.06064 12.417 6.18959 11.2933C6.19123 11.279 6.19283 11.2645 6.19604 11.2356L6.44784 8.96942Z"
        fill="white"
        stroke="#5D7285"
        stroke-width="2"
      />
  ...
  return (
    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_1_8236)">
        <path
          d="M6.93359 7.80078L10.8004 3.93397L6.93359 0.0671611"
          stroke="#5D7285"
          stroke-width="2"
          stroke-linecap="round"
          stroke-linejoin="round"
...
export const QuestionMarkIcon = () => {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="9" stroke="#0000FF" stroke-width="2" />
...
export const LocationPointMarkerIcon = () => {
  return (
    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M39.5846 20.3125C39.5846 32.0312 25.0013 43.75 25.0013 43.75C25.0013 43.75 10.418 32.0312 10.418 20.3125C10.418 12.546 16.9471 6.25 25.0013 6.25C33.0555 6.25 39.5846 12.546 39.5846 20.3125Z"
        fill="#00AEEF"
        stroke="white"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <ellipse cx="25" cy="20.834" rx="6.25" ry="6.25" fill="white" />
    </svg>
  );
};
...
export const RefreshIconTransaction = ({ color }) => {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14 15L10 19L14 23" stroke={color || "white"} />
      <path
        d="M18.0622 8.5C18.7138 9.62862 19.0374 10.9167 18.9966 12.2193C18.9557 13.5219 18.5521 14.7872 17.8311 15.8728C17.11 16.9584 16.1003 17.8212 14.9155 18.364C13.7307 18.9067 12.4179 19.108 11.1249 18.9451"
        stroke={color || "white"}
        stroke-linecap="round"
      />
      <path d="M10 9L14 5L10 1" stroke={color || "white"} />
      <path
        d="M5.93782 15.5C5.27676 14.355 4.95347 13.0462 5.0054 11.7251C5.05733 10.404 5.48234 9.12457 6.23124 8.03498C6.98013 6.9454 8.02229 6.09019 9.23708 5.56834C10.4519 5.04649 11.7896 4.87934 13.0955 5.08625"
        stroke={color || "white"}
        stroke-linecap="round"
...
export const DropDownIcon = () => {
  return (
    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M10.1611 0.314094L5.99463 4.48054L1.82819 0.314094C1.4094 -0.104698 0.732886 -0.104698 0.314094 0.314094C-0.104698 0.732886 -0.104698 1.4094 0.314094 1.82819L5.24295 6.75705C5.66175 7.17584 6.33826 7.17584 6.75705 6.75705L11.6859 1.82819C12.1047 1.4094 12.1047 0.732886 11.6859 0.314094C11.2671 -0.0939597 10.5799 -0.104698 10.1611 0.314094Z"
        fill="#222222"
      />
    </svg>
  );
...
export const DeleteIcon = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 11V17" stroke="#E04F64" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M14 11V17" stroke="#E04F64" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M4 7H20" stroke="#E04F64" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path
