        ...
        <div className="flex items-center justify-end px-2 md:w-full md:px-0">
          <div className="relative w-[272px]">
            <input
              ...
              className="h-[48px] w-full rounded-lg border border-[#D1D5DB] px-[16px] pr-[40px] text-[14px] text-[#222222] transition-shadow duration-200 focus:outline-none focus:ring-2 focus:ring-[#0653EA]"
            />
            <div className="absolute right-[16px] top-1/2 h-[17px] w-[17px] -translate-y-1/2 cursor-pointer text-gray-500">
              <MagnifyingGlassIcon />
            </div>
          </div>
