    ...
    <div className="mx-auto flex h-screen w-screen items-center justify-center bg-[#F6FAFF] max-sm:bg-[white] md:h-full md:w-full">
      ...
      >
        ...
        <LoadingButton
          ...
          onClick={() => loginUser(false)}
          isLoading={isLoading}
          className="flex w-full items-center justify-center rounded-lg border border-[#595959] py-4 pl-[18px] text-[15px] text-[#595959] transition-all duration-500 ease-in-out hover:bg-bleach-blue"
        >
          More Options
        </LoadingButton>
