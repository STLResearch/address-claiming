...
const SuccessModal: React.FC<SuccessModalProps> = ({ closePopUp, isSuccess,errorMessages }) => {
  ...
  return ( 
    <div className="claim-modal-step fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white md:rounded-[30px] w-full max-h-screen h-screen md:max-h-[640px] md:h-auto overflow-y-auto overflow-x-auto md:w-[689px] z-[500] flex flex-col gap-[15px] ">
