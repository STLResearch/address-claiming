        ...
        <>
          {!showMobileNavbar && (
            <nav className="no-scrollbar fixed bottom-0 left-0 z-50 flex w-full overflow-y-scroll border-t-2 bg-white">
              ...
              <SidebarItemMobile href={"/airspaces"} text={"Air Rights"} numberOfUnseenNotifications={0}>
                <GiftIconsidebar isActive={false} />
              </SidebarItemMobile>
              <SidebarItemMobile href={"/buy"} text={"Buy Air Rights"} numberOfUnseenNotifications={0}>
