const DroneSVGComponent = ({ droneColor, direction }) => {
  return (
    <div className={`svg-container w-[30px] h-[30px] rotate-${direction}`}>
      <div className="flex items-center justify-center">
        <svg width="100px" height="100px" viewBox="0 0 25 25" fill="none">
          <path
        ...
        >
          <path
            d="M5 3L0.5 5.59808L0.5 0.401924L5 3Z"
            fill={`${droneColor}`}
            stroke="white"
            strokeWidth={0.5}
          />
