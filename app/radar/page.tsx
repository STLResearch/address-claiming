...
import { Coordinates, JsonObject } from "@/types";
import useDroneSocket from "@/hooks/useDroneSocket";
import { drawFlightPath } from "@/utils/maputils/drawFlightPath";
import { handleClick, handleMobileTouchEnd, handleMouseEnter, handleMouseLeave } from "@/utils/eventHandlersUtils/eventHandlers";
import { createMarker, createMarkerElement, removeMarkerElements } from "@/utils/maputils/markerUtils";
import DroneSVGComponent from "@/Components/Radar/Modals/DroneSVGComponent";
import { closePopups } from "@/utils/popupUtils/popupFunctions";
import { flyToUserIpAddress, getAddresses, goToAddress } from "@/utils/apiUtils/apiFunctions";
import MobileExplorer from "@/Components/Radar/ExplorerMobile/MobileExplorer";
import { handleZoomIn, handleZoomOut, toggleMapView } from "@/utils/maputils";
import { RadarLayerIcon, RadarLocationIcon } from "@/Components/Icons";
import DroneMobileBottomBar from "@/Components/Radar/Modals/DroneMobileBottomBar";
import RadarModal from "@/Components/Radar/Modals/RadarModal";
import Explorer from "@/Components/Radar/Explorer/Explorer";
      ...
      droneData?.forEach((data, index) => {
        ...
        const droneColor =
          isDroneSVGColor[index] || isDroneHoverSVGColor[index]
            ? "#FF3D00"
            : "#0000FF";
        markerElement.innerHTML = ReactDom.renderToString(
          <DroneSVGComponent
