          ...
          <div className="font-[400] text-[14px] leading-7 text-center text-[#FFFFFF] font-poppins">
            {finalAns?.status === "Rent SuccessFull" && (
              <div>
                ...
                {` for `} <span className=" text-[14px] font-bold">$1</span>
              </div>
            )}
          </div>
              ...
              <div
                ...
                className={
                  item.id != selectedAddress
                    ? ` p-3.5  text-left text-[#913636] w-full flex justify-between text-[12px] items-center`
                    : `bg-[#0653EA] p-4 text-left text-white w-full flex justify-between text-[10px]`
                }
                style={{
              ...
              >
                ...
                <div className="flex justify-end items-center min-w-[30%] gap-[4px]">
                  ...
                  <button
                    ...
                    className={
                      item.id != selectedAddress
                        ? "bg-[#0653EA] text-white rounded-lg  text-center text-[15px] font-normal cursor-pointer  w-[54px] h-[31px]"
                        : "bg-[#e8e9eb] text-[#0653EA] rounded-lg  text-center text-[15px] font-normal cursor-pointer w-[54px] h-[31px]"
                    }
                  >
                    RENT
                  </button>
