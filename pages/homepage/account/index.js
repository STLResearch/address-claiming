...
const Portfolio = () => {
    ...
    const onVerifyMyAccount = () => {
        ...
        const getStatusMessage = (statusId) => {
            switch (statusId) {
              case 0:
                return "Your account is not verified. We verify the identity of our customers to assess potential risks, prevent fraud, and comply with legal and regulatory requirements. Note that we store your data securely with advanced encryption and strict authentication measures to ensure utmost privacy and protection.";
              case 1:
                return "Our team is currently conducting a review of your Know Your Customer (KYC) documentation. We appreciate your patience during this process and will notify you promptly upon its completion.";
              case 2:
                return "Thank you, your account is successfully verified. We verify the identity of our customers to assess potential risks, prevent fraud, and comply with legal and regulatory requirements. Note that we store your data securely with advanced encryption and strict authentication measures to ensure utmost privacy and protection.";
              case 3:
                return "We regret to inform you that your account verification was unsuccessful.";
              default:
                return "";
            }
          };
                    ...
                    <section className="relative w-full h-full flex flex-col py-[29px] px-[21px] md:pl-[54.82px] md:pr-[47px] gap-[29px] md:mb-0 mb-[78.22px] overflow-y-auto">
                        ...
                        <div className="flex flex-col py-[17px] px-[25px] rounded-[30px] gap-[15px] bg-white" style={{ boxShadow: '0px 12px 34px -10px #3A4DE926' }}>
                            <div className="flex items-center justify-between">
                                ...
                                {personalInformation.KYCStatusId === 2 && <div className="flex justify-center items-center bg-[#1FD387] rounded-[50%] w-[42px] h-[42px]">
                            ...
                            <p className="font-normal text-base text-[#87878D] pr-[42px]">
                                {getStatusMessage(personalInformation.KYCStatusId)}
                            </p>
