  ...
  return (
    <Fragment>
      ...
      <select
        ...
        name="timeZone"
        id="timeZone"
        className="w-full rounded-lg py-[16px] px-[22px] text-[#222222] text-[14px] font-normal appearance-none focus:outline-none"
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-[66px]">
          <select
            ...
            name={`${index}/start`}
            id={`${index}/start`}
            className="rounded-lg py-[5px] px-[22px] text-[#87878D] text-[14px] font-normal appearance-none focus:outline-none"
            style={{ border: "1px solid #87878D" }}
          >
            {options.map((_, index) => (
              <option value={index}>
...
const Slider = () => {
  ...
  return (
    <div
      ...
      className={`cursor-pointer rounded-t-[30px] absolute ${isFullyVisible ? "bottom-0" : "-bottom-[600px]"} right-6 flex flex-col items-center gap-[34px] py-[43px] px-[23px] bg-white max-w-[362px] duration-1000`}
    >
...
const HowToModal = ({ goBack }) => {
  ...
  return (
    <div className="absolute w-screen h-screen bg-white flex flex-col justify-center items-center z-50">
      <div
        onClick={goBack}
        className="w-[14px] h-[14px] absolute top-[26px] right-[18px]"
      >
        <CloseIcon />
      </div>
      {section === 0 && (
        <div className="flex flex-col gap-[15px] items-center justify-center px-[30px]">
          ...
          <p className="px-[30px] text-[15px] text-center text-[#222222]">
            Ready to claim your airspace? No registered airspace yet, but
            exciting times ahead! 🚀✨
          </p>
          <div
            onClick={() => setSection(1)}
            className="bg-[#0653EA] rounded-[8px] py-[16px] w-full text-center text-white cursor-pointer"
          >
            Next
          </div>
        </div>
